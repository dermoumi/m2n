...
local Texture2D   = require 'nx.graphics.texture2d'
local Entity2D    = require 'nx.graphics.entity2d'
local class       = require 'nx.class'

local Sprite = class 'nx.graphics.sprite'
...
function Sprite:setTexture(texture, keepSubrect)
    if type(texture) == 'string' or texture.class.name == 'nx.graphics.image' then

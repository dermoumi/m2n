...
function Renderer.init()
    ...
    local Shader = require('nx.graphics.shader')
    ...
    vbFsQuad = require('nx.graphics.arraybuffer').vertexbuffer(ffi.sizeof(buffer), buffer)

    -- Create the default, empty texture
    defaultTexture = require('nx.graphics.texture'):new()
        :create('2d', 1, 1, 1, 0, 0)
...
function Renderer.drawFsQuad(texture, width, height)
    ...
    require('nx.graphics.arraybuffer').setVertexbuffer(vbFsQuad, 0, 0, 16)

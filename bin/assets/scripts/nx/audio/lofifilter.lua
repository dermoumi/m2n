...
local AudioLofiFilter = AudioFilter:subclass('nx.audio.lofifilter')
...
------------------------------------------------------------
function AudioLofiFilter:initialize()
    local handle = C.nxAudioFilterLofiCreate()

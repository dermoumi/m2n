...
namespace Audio
{
    ...
    public:
        ...
        virtual void filter(float* buffer, unsigned int samples, unsigned int channels,
            float sampleRate, double time);
        virtual void filterChannel(float* buffer, unsigned int samples, float sampleRate,
            double time, unsigned int channel, unsigned int channels);

...
extern "C"
{
    ...
    NX_EXPORT NxWindow* nxWindowCreate(const char* title, int width, int height, bool fullscreen)
    {
        ...
        if (!extensionsInitialized) {
            ...
            #else
                Log::info("EXT_framebuffer_object %i", glExt::EXT_framebuffer_object);
                Log::info("EXT_framebuffer_multisample %i", glExt::EXT_framebuffer_multisample);
                Log::info("EXT_texture_filter_anisotropic %i", glExt::EXT_texture_filter_anisotropic);
                Log::info("EXT_texture_compression_s3tc %i", glExt::EXT_texture_compression_s3tc);
                Log::info("EXT_texture_sRGB %i", glExt::EXT_texture_sRGB);
                Log::info("ARB_texture_float %i", glExt::ARB_texture_float);
                Log::info("ARB_texture_non_power_of_two %i", glExt::ARB_texture_non_power_of_two);
                Log::info("ARB_timer_query %i", glExt::ARB_timer_query);
            #endif
            Log::info("================");
        }
